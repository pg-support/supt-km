# Service countries & regions
- We only offer warranty services to the countries/regions we ship the product to, see [[Countries we ship to]].  
- For countries in Asia that we used to sell directly, we still have to offer service for the products we sold to customers. Refer to [[RMA & OOW for Southeast Asia]].
